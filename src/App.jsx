  ...
  return (
    <>
      <AppBar
        position="static"
        elevation={0}
        sx={{ ...styles.appBar, zIndex: 10, position: "relative" }}
      >
                ...
                >
                  <Button
                    ...
                    sx={{
                      ...
                      textDecoration:
                        currentPage === "home" ? "underline" : "none",
                    }}
                  >
                    Home
                  </Button>
                  ...
                  {navLinks.map((link) => (
                    <Button
                      ...
                      sx={{
                        ...styles.navLinkButton,
                        textDecoration:
                          currentPage === link.key ? "underline" : "none",
                      }}
                    >
                      {link.label}
                    </Button>
